    ...
    <body>
        <div class="sticky top-0 z-50 font-sans text-gray-900 antialiased">
            <header class=""> 
                <div class="container relative z-10 max-w-screen-2xl">
                    <nav class="flex items-center justify-between bg-violet-950 h-20 gap-12 w-screen">
                        <a
                            href="#"
                        ...
                        >
                            ...
                            <div class="w-36 flex items-center justify-center">
                                <img class="rounded-md" src="{{asset('img/logo.jpg')}}" alt="">
                                {{-- <span>HIO</span> --}}
                            </div>
                        ...
                        <ul class="items-start hidden mr-32 gap-8 text-base font-medium lg:flex">
                            <li>
                                <a
        ...
        <div class="w-screen flex items-center justify-center animate-[fadein_2s_ease-in_1] shadow-md">
            ...
            <div class="relative">
                ...
                <div class="relative lg:absolute lg:top-20 lg:left-20 px-4 py-3 lg:w-2/5 bg-gray-100/50 rounded-lg">
